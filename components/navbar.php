<div class="py-4 w-full fixed top-0 z-50">
    <div class="flex items-center w-[92%] md:w-[85%] mx-auto py-2 justify-between">
        <a href="/" class="w-[180px] cursor-pointer">
            <img class="w-full" src="./assets/logo/Rowancare-logo.png" alt="">
        </a>
        <div class="hidden md:flex items-center gap-10">
            <a class="text-[17px] hover:text-[#0D57E3] duration-300 font-medium" href="">Home</a>
            <a class="text-[17px] hover:text-[#0D57E3] duration-300 font-medium" href="pages/pharmacy.php">Pharmecy</a>
            <a class="text-[17px] hover:text-[#0D57E3] duration-300 font-medium" href="pages/aboutus.php">About
                Us</a>
            <a class="text-[17px] hover:text-[#0D57E3] duration-300 font-medium" href="pages/contactus.php">Contact
                Us</a>
        </div>
