    ...
    <main>
        ...
        <div class="w-[92%] md:w-[85%] mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-9 my-20 gap-4">
                <div class="border-2 h-auto col-span-9 md:col-span-2 rounded-lg">
                    ...
                    <form action="book-appointment.php" method="post" class="px-4 py-3">
                        <div>
                            ...
                            <div class="form-checkbox">
                                ...
                                <label for="genderMale" class="flex items-center cursor-pointer">
                            ...
                            <div class="form-checkbox">
                                ...
                                <label for="genderFemale" class="flex items-center cursor-pointer">
                                    <span class="w-4 h-4 inline-block mr-2 rounded border border-gray-400"></span>
                                    Female Doctor
                                </label>
                            </div>
                        ...
                        <div class="my-4">
                            ...
                            <div>
                                <?php foreach ($specializaitons as $sp): ?>
                                    <div class="form-checkbox">
                                        <input type="checkbox" id="<?php echo $sp['name'] ?>" name="specialization" value="<?php echo $sp['name']; ?>"
                                            class="hidden" <?php echo $sp['specializationId'] == 1 ? "checked" : "" ?> />
                                        <label for="<?php echo $sp['name']; ?>" class="flex items-center cursor-pointer">
                                            <span class="w-4 h-4 inline-block mr-2 rounded border border-gray-400"></span>
                                            <?php echo $sp['name'] ?>
                                        </label>
                                    </div>
                        ...
                        <div class="row-span-2 bg-red-50">
                            <button
                                class="text-center bg-[#0D57E3] hover:bg-[#0a43b0] duration-500 text-white w-full py-2 rounded-md outline-none border-none cursor-pointer flex items-center justify-center font-medium"
                                type="submit">Search</button>
                        </div>
                    </form>
                </div>
                <div class="border-2 h-[50vh] col-span-9 md:col-span-7"></div>
            </div>
        </div>
